...
public class Main {
	...
	static ShoesData_Casual sd_c = new ShoesData_Casual();
	static ShoesData_Sneakers sd_sn = new ShoesData_Sneakers();
	static ShoesData_Sports sd_sp = new ShoesData_Sports();
	 ...
	 * how : 상품 정보 조회 메소드
	 */
	public static void shoesLookup() {
	 ...
	 */
	public static void shoesModordel() {
		System.out.println("상품 정보를 조회합니다.");
		System.out.println("1. 캐주얼화");
		System.out.println("2. 스니커즈");
		System.out.println("3. 운동화");
